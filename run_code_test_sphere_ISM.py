...
savefile = './savefile.short.onaxis.sphere.ISM.p'   #.n-4
...
outputfile = './afterglow_sych_spectrum.sphere.ISM.p'   # .n-4
...
phi_slices = 2 #54 #18 #54  #18  # 18 is alright, 54 is probably better.  If you are doing an on-axis models, you an set this to 2.
...
eiso = 1.e52 #1e53 #3.1e49 #1.5e49 #1e47 #2.5e51 #1.7e51 # 1.e49  # 2.5e51 # 1.e51
...
shock_thickness = 1.e3 #0.1  # * gv.cl 
